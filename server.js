...
// var pixabay_api = "48713575-5dd5827a7e15db93aa7483189";
// var URL =
...
app.get(
  ...
  asyncHandler(async (req, res) => {
    console.log("API /api/search route hit"); // Debugging line
...
app.get("/api/placeholder/:width/:height", (req, res) => {
  console.log("API /api/placeholder/:width/:height route hit");
