...
function updateDetailsTab() {
  ...
  if (!currentRecipe) {
    detailsContainer.innerHTML = `
      <div class="empty-state" style="text-align: center; padding: 20px; color: #666;">
        <i class="fas fa-exclamation-circle" style="font-size: 2rem; color: #ccc;"></i>
        <p style="font-size: 1.1rem; margin-top: 10px;">No recipe data available</p>
      </div>`;
    return;
  }

  // Calculate times with fallbacks
  ...
  // Build rating display using stars
  ...
  // Get the recipe image; fallback if missing
  const imageSrc = imageUrl.get(currentRecipe.recipe_id) || "default-image.jpg";

  // Map each recipe category to a clickable link using its URL.
  ...
  detailsContainer.innerHTML = `
    <div class="recipe-card" style="
      ...
      <!-- Recipe Image -->
      <div class="image-container" style="text-align: center; margin-bottom: 16px;">
        <img src="${imageSrc}" alt="${currentRecipe.recipe_name}" 
             class="recipe-image"
             style="width: 100%; max-width: 480px; height: auto; object-fit: cover; 
      ...
      <div class="recipe-stats" style="
            ...
            flex-wrap: wrap; 
            margin-bottom: 16px;">
        <div class="stat" style="font-size: 1rem; color: #555; margin: 6px;">
          <i class="fas fa-star" style="color: #FFD700; margin-right: 4px;"></i> ${rating}
        </div>
        <div class="stat" style="font-size: 1rem; color: #555; margin: 6px;">
          <i class="fas fa-clock" style="margin-right: 4px;"></i> Total: ${totalTime} min
        </div>
        <div class="stat" style="font-size: 1rem; color: #555; margin: 6px;">
          <i class="fas fa-hourglass-start" style="margin-right: 4px;"></i> Prep: ${prepTime} min
        </div>
        <div class="stat" style="font-size: 1rem; color: #555; margin: 6px;">
          <i class="fas fa-fire" style="margin-right: 4px;"></i> Cook: ${cookTime} min
        </div>
      </div>
      ...
      <div class="recipe-description" style="
            ...
            color: #666;
            text-align: justify;">
        <i class="fas fa-info-circle" style="margin-right: 8px; color: #4CAF50;"></i>
        ${currentRecipe.recipe_description}
      </div>
      `
          : ""
      ...
      <div class="recipe-categories" style="
            ...
            font-size: 0.95rem; 
            text-align: center;">
        <i class="fas fa-tags" style="color: #4CAF50; margin-right: 6px;"></i>
        <span>${categoriesList}</span>
      </div>
      
      <!-- Call-to-Action Button -->
      <div style="text-align: center;">
        <a href="${recipeUrl.get(
        ...
        <div class="nutrition-column">
          ...
          <div class="nutrition-grid">
            <div class="nutrition-item">
              ...
              <span class="nutrient-value">${nutrition.vitamin_a || "0"}%</span>
            </div>
            <div class="nutrition-item">
              <span class="nutrient-name">Vitamin C</span>
              <span class="nutrient-value">${nutrition.vitamin_c || "0"}%</span>
            </div>
            <div class="nutrition-item">
        ...
        <div class="nutrition-section">
          ...
          <div class="nutrition-grid">
            ...
            <div class="nutrition-item">
              ...
              <span class="nutrient-value">${nutrition.trans_fat || "0"}g</span>
            </div>
            <div class="nutrition-item">
